    ...
    with open(output_file, mode='w', newline='') as csv_file:
        ...
        with open(input_csv_file, mode='r') as input_csv:
            ...
            for i, row in enumerate(reader, start=1):
                ...
                node_name = row.get('display', '')  # Get the value with a fallback to an empty string
...
if __name__ == "__main__":
    ...
    csv_file_path = 'T_interfacesfiltered.csv'
    ...
    ##############ADAPT the name for nodefiltered_properties.csv
    node_filtered = pd.read_csv('T_interfacesfiltered.csv')
    ...
    dev_properties.to_csv('T_interfaces_properties.csv', index=False)

    # Example usage:
    generate_csv_file( "T_interfacesfiltered.csv", "T_interfaces_elements.csv")
